    ...
    <div style={{ perspective: 2000 }}>
      ...
      >
        <motion.h1
          ...
          className="absolute left-0 flex items-center justify-center w-full text-3xl font-extrabold text-blue-800 md:text-5xl top-5"
        >
        ...
        >
          ...
          <Link href="">
            <a
              href={props.projectsData[0]?.link}
